...
export class RouterService {
  ...
  updateBreadCrumb() {
    ...
    switch (this.route.length) {
      case 2: {
        this.breadCrumb = { breadCrumbSegments: [firstBreadCrumbSegment], showBreadcrumb: true };
        return;
      }
      case 3: {
        this.breadCrumb = { breadCrumbSegments: [firstBreadCrumbSegment], showBreadcrumb: true };
      ...
      case 5: {
        this.breadCrumb = { breadCrumbSegments: [firstBreadCrumbSegment, secondBreadCrumbSegment], showBreadcrumb: true };
        return;
      }
      default:
        break;
  ...
  evalReleases() {
    ...
    if (this.isReleases) {
      if (this.first === PROJECTS) this.releaseContextRoute = PROJECTS + this.route[1];
      if (this.first === COMPONENTS) this.releaseContextRoute = COMPONENTS;
    }
  }
